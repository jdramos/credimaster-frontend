    ...
    const fetchCustomer = async () => {
      try {
        ...
        const formattedCustomer = {
          ...
          job_start_day: record.job_start_day
            ? dayjs(record.job_start_day)
            : "",
          identity_expiration_date: record.identity_expiration_date
            ? dayjs(record.identity_expiration_date)
            : "",
          business_license_expiry: record.business_license_expiry
            ? dayjs(record.business_license_expiry)
            : "",
          business_license_issued: record.business_license_issued
            ? dayjs(record.business_license_issued)
            : "",
    ...
    setCustomer((prevCustomer) => ({
      ...
      business_annual_income:
        name === "business_monthly_income"
          ...
          : prevCustomer.business_annual_income,
      annual_salary:
        name === "monthly_salary"
          ? formatNumber(value * 12)
          : prevCustomer.annual_salary,
      // replace with upper case the first letter of every word of the name
      reference_name:
        name === "reference_name"
          ? value.replace(/\b\w/g, (l) => l.toUpperCase())
          : prevCustomer.reference_name,
      customer_name:
        name === "customer_name"
          ? value.replace(/\b\w/g, (l) => l.toUpperCase())
          : prevCustomer.customer_name,
      public_name:
        name === "public_name"
          ? value.replace(/\b\w/g, (l) => l.toUpperCase())
          : prevCustomer.public_name,
      reference2_name:
        name === "reference2_name"
          ? value.replace(/\b\w/g, (l) => l.toUpperCase())
          : prevCustomer.reference2_name,
      identity_expiration_date:
        name === "identity_issue_date"
          ? dayjs(value).add(10, "year")
          : prevCustomer.identity_expiration_date,
            ...
            >
              <div id="datos-personales">
                ...
                >
                  {errors.birth_country_id && (
                    <FormHelperText>{errors.birth_country_id}</FormHelperText>
                  )}
                </CountrySelect>
              ...
              <div id="datos-laborales">
                <FormControl sx={{ m: 1, minWidth: 120 }} size="small">
                  <InputLabel id="economic_activity">
                    Actividad económica
                  </InputLabel>
                  <Select
                  ...
                  <>
                    <div id="datos-negocio">
                      ...
                      <TextField
                        ...
                        onChange={handleInputChange}
                        error={Boolean(
                          errors.business_telephone && !isEmployee,
                        )}
                      ...
                      <TextField
                        ...
                        onChange={handleInputChange}
                        error={Boolean(
                          errors.business_inventory && !isEmployee,
                        )}
                      ...
                      <TextField
                        ...
                        onChange={handleInputChange}
                        error={Boolean(
                          errors.business_receivables && !isEmployee,
                        )}
                      ...
                      <TextField
                        ...
                        onChange={handleInputChange}
                        error={Boolean(
                          errors.business_monthly_income && !isEmployee,
                        )}
                        helperText={
                          errors.business_monthly_income && !isEmployee
                        }
                      ...
                      <TextField
                        ...
                        onChange={handleInputChange}
                        error={Boolean(
                          errors.business_annual_income && !isEmployee,
                        )}
                        helperText={
                          errors.business_annual_income && !isEmployee
                        }
