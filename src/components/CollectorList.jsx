    ...
    return (
        <div>
            ...
            <div style={{ height: 40, width: '100%' }}>
                <Alert variant="filled" icon={false} severity="info" sx={{ mt: 5 }}>
                    <h2>Listado de colectores
                        <AddCircle goTo="/colectores/agregar" />
                    </h2>
                </Alert>

                <DataTable data={data} columns={columns} route="colectores" />
            </div>
