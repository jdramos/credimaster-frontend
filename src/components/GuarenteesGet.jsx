...
const GuaranteesGet = ({ apiUrl, totalGuaranteeValue = 0 }) => {
  ...
  const displayTotal =
    totalValue > 0 ? totalValue : toMoney(totalGuaranteeValue);
          ...
          endAdornment: (
            <InputAdornment position="end">
              <Tooltip title="Ver detalle de garantías" arrow>
                <IconButton onClick={handleOpen} aria-label="Ver garantías">
                  <VisibilityIcon />
                </IconButton>
              </Tooltip>
            </InputAdornment>
              ...
              <Table size="small">
                ...
                <TableBody>
                  ...
                  >
                    ...
                    <TableCell align="right">
                      <MoneyText value={displayTotal} bold />
                    </TableCell>
                  </TableRow>
                </TableBody>
              </Table>
